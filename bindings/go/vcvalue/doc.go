// Package vcvalue is the durable, dependency-free layer of the vitaminc Go
...
// import this package for its encode/decode surface; the wasm reference
// harness (package vitaminc) is only one consumer of it.
//
...
// # Decoding
//
// Unmarshal turns value transport bytes into Go natives (nil, bool, float64,
// int64, uint64, string, []byte, []any, and the ordered Object type for
// maps). A reflection-based Unmarshal into caller structs is future work.
//
...
// envelope. Durable cross-language database interop is the EQL layer's job,
